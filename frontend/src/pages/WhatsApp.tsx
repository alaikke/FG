  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 mt-10">
      ...
      <div className="bg-white p-10 md:p-16 rounded-[3rem] shadow-[0px_20px_40px_rgba(0,0,0,0.06)] border border-slate-100 max-w-2xl w-full text-center relative overflow-hidden group">
        ...
        <div className="absolute -top-24 -right-24 w-64 h-64 bg-green-200 rounded-full blur-[80px] opacity-40 group-hover:opacity-60 transition-opacity duration-700"></div>
        <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-blue-100 rounded-full blur-[80px] opacity-40 group-hover:opacity-60 transition-opacity duration-700"></div>

        <div className="relative z-10 flex flex-col items-center">
          
          {/* Aesthetic Center Icon */}
          <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-[2rem] flex items-center justify-center shadow-[0_12px_24px_rgba(34,197,94,0.3)] mb-8 -rotate-3 hover:rotate-0 transition-transform duration-500">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 font-headline tracking-tight">
            Suporte <span className="bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent">Humanizado</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            ...
            <a 
              ...
              className="flex-1 flex justify-center items-center gap-2 bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-4 font-bold text-lg rounded-full hover:shadow-[0_12px_32px_rgba(34,197,94,0.3)] hover:-translate-y-1 transition-all duration-300 font-headline"
            >
